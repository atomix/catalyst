 ...
 * </pre>
 * <p>
 * Buffers implement {@link net.kuujo.catalyst.util.ReferenceCounted} in order to keep track of the number of currently
 ...
 * {@link net.kuujo.catalyst.util.ReferenceCounted#acquire()} and released via
 * {@link net.kuujo.catalyst.util.ReferenceCounted#release}. Once all references to a buffer have been released - including
...
public interface Buffer extends BytesInput<Buffer>, BufferInput<Buffer>, BytesOutput<Buffer>, BufferOutput<Buffer>, ReferenceCounted<Buffer> {
   ...
   * defined by {@link net.kuujo.catalyst.util.ReferenceCounted} will be decremented. However, if references to the
