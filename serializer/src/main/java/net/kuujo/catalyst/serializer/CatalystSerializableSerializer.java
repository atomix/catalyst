 ...
 * <p>
 * During deserialization, if the serializable type also implements {@link net.kuujo.catalyst.util.ReferenceCounted} then the serializer will
 * make an effort to use a {@link net.kuujo.catalyst.util.ReferencePool} rather than constructing new objects. However, this requires that
 * {@link net.kuujo.catalyst.util.ReferenceCounted} types provide a single argument {@link net.kuujo.catalyst.util.ReferenceManager} constructor. If an object is
 * {@link net.kuujo.catalyst.util.ReferenceCounted} and does not provide a {@link net.kuujo.catalyst.util.ReferenceManager} constructor then a {@link SerializationException}
 * will be thrown.
 *
