...
public interface Connection {
   ...
   * @throws IllegalStateException if not called from a Catalyst thread
   */
  <T, U> CompletableFuture<U> sendAndReceive(T message);
   ...
   * @throws IllegalStateException if not called from a Catalyst thread
   */
  <T, U> Connection handler(Class<T> type, Consumer<T> handler);
   ...
   * @throws IllegalStateException if not called from a Catalyst thread
   */
  <T, U> Connection handler(Class<T> type, Function<T, CompletableFuture<U>> handler);
   ...
   * {@link Connection#handler(Class, Function) received} by the connection. Any
